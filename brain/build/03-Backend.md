...
- **PSD2/SCA (EU/EEA + UK)**: hosted Checkout handles 3DS entirely — another reason to use it. Exemptions (low-value <€30, TRA, trusted beneficiary) **kill liability shift** — fraud chargebacks land on you. **PSD3/PSR** ⚠️ verified: 2026-08 final text published Apr 2026 (PSR applies ~21 months after entry into force (expected H1 2028)); card fraud is 17× higher outside the EEA.
