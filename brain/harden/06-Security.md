...
- **Supply chain**: 71% of orgs had a material third-party supply-chain incident in the past year (SecurityScorecard 2025). SBOM, artifact signing (SLSA), dependency pinning, automated SCA, lockfiles. A dependency is code you ship — scan it like yours.
