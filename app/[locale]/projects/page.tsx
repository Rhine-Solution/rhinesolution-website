...
export default async function ProjectsPage({ params }: Props) {
  ...
  const items = sortProjects(getProjects(content, ["project_rhinesolution", "project_brain", "project_macmini", "project_music", "project_plan2shift", "project_spendtracker"]));
