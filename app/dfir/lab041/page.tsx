...
export const metadata: Metadata = {
  title: "LAB041 â€” Oude MP3-speler",
  description:
  ...
  alternates: {
    canonical: "https://rhinesolution.com/dfir/lab041",
  },
};
...
const tables: {
...
}[] = [
  {
    ...
    rows: [
      ...
      { cells: ["Capacity", "Â± 114 MB (235,008 sectors)"] },
  ...
  },
  {
    ...
    rows: [
      ...
      { cells: ["Date / time", "09-09-2022 09:02:09 â€“ 09:07:33 (UTC)"] },
  ...
  },
  {
    ...
    rows: [
      ...
      { cells: ["4", "Special D - Here I Amâ€¦mp3", "6,850,560 B", "Piracy URL in name + tags"], strong: true },
      { cells: ["5", "Special D â€¦mp3-slack", "14,336 B", "Slack space with same URL"] },
...
const findings = [
  {
    ...
    body: "Two files reference sites distributing music without permission from rights holders. â€œSpecial D - Here I Am (Extended Mix)(www.djwitek.prv.pl).mp3â€ contains the URL www.djwitek.prv.pl in its filename and repeatedly in its ID3 tags (TIT2, TPE1, TYER, TRCK). â€œZoop - Zoop In Afrika (Djeo Madjula).wmaâ€ references www.mp3xplosion.com in its filename. The slack space of the Special D MP3 also contains www.djwitek.prv.pl. Keyword search: 3 hits for djwitek.prv.pl, 1 for mp3xplosion.com.",
  },
  {
    id: "6.3",
    title: "Audio files",
  ...
  },
  {
    ...
    body: "REC_0001.WAV (13,824 B) and REC_0002.WAV (11,776 B) are short voice-recorder captures â€” valid RIFF/WAVE PCM with short robotic sounds. Not relevant to the research question, kept for completeness.",
  },
  {
    id: "6.5",
    title: "The â€œ_rans.docâ€ file",
    body: "Flagged as a Notable Item. The name suggests a Word document, but it lacks the D0CF11E0 OLE header, contains no readable text, and appears encoded. Modification time 24-04-2005 16:05:34 (CET) fits the device's usage period. It cannot be opened as-is; the â€œ_ransâ€ name may hint at â€œransomâ€, but no conclusion is drawn. Reported as an open point.",
  },
  {
    id: "6.6",
    title: "File carving (recovered files)",
    body: "PhotoRec carved several MP3s from unallocated space â€” data that once belonged to deleted files and was never overwritten. Recovered tracks include â€œWat Zullen We Drinkenâ€ (DJ Sam & Moos) and â€œZwarte crossâ€ (Normaal), indicating the device stored music files that were later deleted.",
  },
];
...
const tools = [
  ...
  { tool: "FTK Imager", version: "â€”", purpose: "Acquisition and hash verification" },
  { tool: "Wayback Machine", version: "â€”", purpose: "Verifying whether domains were previously active" },
  { tool: "DNS Lookup", version: "â€”", purpose: "Domain registration and history lookup" },
];
      ...
      <main id="main" className="container page">
        <header className="dfir-hero">
          <p className="section-eyebrow">
            <Link href="/dfir" style={{ color: "inherit" }}>Digital Forensics</Link> Â· Case LAB041
          </p>
          <h1>LAB041 â€” Oude MP3-speler</h1>
        ...
        <section>
          ...
          <p>
            ...
            ID3 metadata. Deleted MP3s â€” including copyrighted tracks â€” were also recovered (carved) from
        ...
        <section>
          <h2>2 Â· Research Question</h2>
          <blockquote className="dfir-quote">
            â€œIs there evidence on the seized MP3 player of (presumably) illegally obtained music, and if
            so, which evidence?â€
          </blockquote>
          <p>
            ...
            notable files (e.g. â€œ_rans.docâ€).
          </p>
        </section>

        <section>
          <h2>3 Â· Evidence &amp; Acquisition</h2>
          <DfirTable {...tables[0]} />
          <DfirTable {...tables[1]} />
        ...
        <section>
          <h2>4 Â· Tools &amp; Method</h2>
          <p>Analysis system: SFDCD (Windows 8, 64-bit). Autopsy â€œingestâ€ ran its automatic analysis routine (metadata, hashes, categorisation); Wayback Machine and DNS lookup verified URL origins.</p>
        ...
        <section>
          <h2>7 Â· Analysis &amp; Interpretation</h2>
          <p>
            The URL traces in filenames and ID3 metadata point toward download via online piracy sites
            (www.djwitek.prv.pl and www.mp3xplosion.com) â€” domains not known as official distribution
            channels. The filename-with-URL format is characteristic of these sites&apos; auto-generated
            downloads. Metadata indicates active use in 2004â€“2005, consistent with the sites being
        ...
        <section>
          <h2>8 Â· Conclusion</h2>
          <p>Yes â€” the seized MP3 player contains evidence of (presumably) illegally obtained music:</p>
          <ul className="dfir-conclusion">
            ...
            <li>Several deleted MP3s â€” including copyrighted tracks â€” were recovered from unallocated space.</li>
          </ul>
          <p className="dfir-note">
            Nuance: possessing protected music on a player is not itself a criminal act â€” the Dutch
          ...
          <p>
            Open points: further (cryptographic) examination of â€œ_rans.docâ€, and examination of the host
            computer for browser downloads and URL origins.
          </p>
        </section>

        <section>
          <h2>9 Â· Fact versus Opinion</h2>
          ...
          <div className="dfir-table-wrap">
            <table className="dfir-table">
              ...
              <tbody>
                <tr><td>â€œSpecial Dâ€¦mp3â€ contains â€œwww.djwitek.prv.plâ€ in its ID3 tags.</td><td>The user downloaded this track illegally.</td></tr>
                <tr><td>â€œ_rans.docâ€ is not a valid Word file and has no readable text.</td><td>It is a ransom note.</td></tr>
...
function DfirTable({ title, label, caption, rows }: (typeof tables)[number]) {
  return (
    <div className="dfir-table-wrap">
      <table className="dfir-table">
        <caption><span>{label}</span> &middot; {title} â€” {caption}</caption>
        <thead>
          <tr>
