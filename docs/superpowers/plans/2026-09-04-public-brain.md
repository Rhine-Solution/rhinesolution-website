...
.markdown :global(.hljs-keyword), .markdown :global(.hljs-selector-tag) { color: #7ea7ff; }
.markdown :global(.hljs-string), .markdown :global(.hljs-attr) { color: #a5d6a7; }
.markdown :global(.hljs-number), .markdown :global(.hljs-literal) { color: #ffd54f; }
.markdown :global(.hljs-comment) { color: rgba(226,234,255,0.45); }
```
